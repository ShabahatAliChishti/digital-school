...
namespace digital_School.Areas.Student.Controllers
{
    public class ArticleController : Controller
    {
        ...
        public ActionResult viewarticle()
        {
            ...
            int stuId = Convert.ToInt32(Session["Student"]);
            var data = db.Articles.Where(x => x.UserId == stuId).ToList();
            return View(data);
        }
        ...
        public ActionResult articletype(tbl_articletypeValidation art)
        {
            try
            {
        ...
        public ActionResult addarticle(tbl_ArticleValidation article)
        {
            try
            {
                ...
                a.imgPath = "~/FrontEnd/Images/ArticleImage/" + filename;
                ...
                a.UserId = Convert.ToInt32(Session["Student"]);
...

        {
            ...
            try
            {
                ...
                if (sa.UserImageFIle != null)
                {
                    ...
                    art.UserId = Convert.ToInt32(Session["Student"]);
                    art.Title = sa.Title;
