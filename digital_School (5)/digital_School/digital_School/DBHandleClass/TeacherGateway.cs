...
namespace digital_School.DBHandleClass
{
    public class TeacherGateway:DBGateway
    {
                ...
                try
                {
                    ...
                    while (reader.Read())
                    {
                        Teacher teacher = new Teacher
                        {
                            ...
                            Class_Id = Convert.ToInt32(reader["DepartmentId"].ToString()),
            ...
            try
            {
                ...
                if(reader.Read())
                {
                     teacher = new Teacher
                    {
                        ...
                        Class_Id = Convert.ToInt32(reader["Class_Id"].ToString()),
                        //CreditTobeTaken = Convert.ToDouble(reader["CreditToBeTaken"].ToString())
        ...
        //        CommandObj.Parameters.AddWithValue("@Class_Id", teacher.Class_Id);
